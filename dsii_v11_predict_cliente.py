"""
DSII V11 — Predicao Cliente (PA-Deviation Architecture, Batch Mode)
"""
...
RESULTS_DIR = Path('C:/Users/DiegoGuerra/Documents/Projetos/genetic_prediction/dsii_v11_results')

INPUT_FILE = DOWNLOADS / 'Cliente José Gonçalvez.xlsx'
OUTPUT_FILE = RESULTS_DIR / 'jose_goncalvez_predictions_v11.xlsx'
EXCLUDED_FILE = RESULTS_DIR / 'jose_goncalvez_excluidos_v11.xlsx'

# Load V11 models
with open(RESULTS_DIR / 'v11_models.pkl', 'rb') as f: saved_models = pickle.load(f)
with open(RESULTS_DIR / 'v11_sire_profiles.pkl', 'rb') as f: sire_profiles = pickle.load(f)
with open(RESULTS_DIR / 'v11_mgs_profiles.pkl', 'rb') as f: mgs_profiles = pickle.load(f)
...
def predict_batch(trait, animals, pl_preds=None):
    ...
    # Fill NaN with 0 (missing cross-trait features)
    ...
    # Convert to absolute: PA + deviation
...
print(f"\n{'='*120}")
print(f"  DSII V11 — PREDICAO CLIENTE JOSE GONCALVEZ (PA-Deviation)")
print(f"{'='*120}")
